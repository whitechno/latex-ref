...
%%%>
\begin{comment}
:Title: Visualization of Two's complement for a 4-bit-value
:Tags: Node positioning;Shadings;Transparency;Angles;Diagrams;Computer science
:Author: Harald Lichtenstein
:Slug: complement

Two's complement is a mathematical operation on binary number. In computing 
it is a method of signed number representation. 
